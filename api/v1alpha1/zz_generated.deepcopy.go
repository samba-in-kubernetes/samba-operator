...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SmbServicePvcSource) DeepCopyInto(out *SmbServicePvcSource) {
	*out = *in
	if in.Spec != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SmbServicePvcSource.
func (in *SmbServicePvcSource) DeepCopy() *SmbServicePvcSource {
	if in == nil {
		return nil
	}
	out := new(SmbServicePvcSource)
	in.DeepCopyInto(out)
	return out
}
